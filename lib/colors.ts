...
export type SemanticColors = {
  ...
  icon:     { onPrimary: string; placeholder: string; error: string };
...
const light: SemanticColors = {
  ...
  icon:     { onPrimary: '#ffffff', placeholder: '#9e9e9e', error: '#f44336' },
...
const dark: SemanticColors = {
  ...
  icon:     { onPrimary: '#ffffff', placeholder: '#757575', error: '#f76e64' },
