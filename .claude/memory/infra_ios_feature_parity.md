...
Реализовано и проверено на живом iPhone: см. [[feature-auth]], раздел «Вход через VK на iOS».
Понадобилось отдельное веб-приложение в консоли VK (`54761714`) — платформа у существующего
зафиксирована как Android и redirect туда вписать некуда.
