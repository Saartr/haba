...
`VK_WEB_CLIENT_ID`, `VK_WEB_CLIENT_SECRET`, `VK_WEB_SERVICE_TOKEN` (ключи веб-приложения VK для входа с iOS), `REVIEW_LOGIN`, `REVIEW_PASSWORD`
(служебный вход модераторов магазинов, добавлены 2026-09-11;
см. [[feature-auth]]).
