...
Текущее значение: 2 (2026-08-30) — **эта сборка опубликована в RuStore**, релиз вышел.
Значит следующая выкладка обязана быть versionCode 3, и у пользователей на руках уже
есть работающая версия: ломающие изменения проверять до релиза, а не после.
